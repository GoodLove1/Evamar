...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('🌐 Support', url=f'https://t.me/fondness_mov')
            ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='http://t.me/KingFilter_bot')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def disable_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('🌐 Support', url=f'https://t.me/fondnesss_mov')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await bot.send_message(
            chat_id=chat_, 
